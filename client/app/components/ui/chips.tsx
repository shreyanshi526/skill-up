...
const ChipButton = ({ label, className, onClick }: ChipButtonProps) => {
  return (
    ...
    >
      ...
      <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-neutral-50 dark:bg-slate-950 px-3 py-1 text-[11px] sm:text-sm font-medium  text-black dark:text-white  backdrop-blur-3xl">
        {label}
      </span>
    </button>
  );
